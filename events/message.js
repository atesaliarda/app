...
if (db.has(`prefix_${message.guild.id}`) === false) {
  ...
  if (cmd) {
    ...
    .setColor("RANDOM")
    .setDescription("**Sen botun komutlarını kullanamazsın! Çünkü botun kara listesindesin Neden Alındıgını Öğrenmek İçin https://discord.gg/NzXJPer destek sunucumuza gel**")
